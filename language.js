const translations = {
  en: {
    ...
    projects4Title: "Housing price prediction",
    projects4descri: "Using multiple variables I created a prediction model using random forest that could aproximate the price of a house given a few variables.",
    projects5Title: "Cats vs Dogs Image Classification",
    projects5descri: "This project is a deep learning model designed to classify images of cats and dogs using Convolutional Neural Networks (CNNs). The dataset consists of labeled images, and the model is trained using TensorFlow and Keras.",
  ...
  es: {
    ...
    projects4Title: "Prediccion de precios de vivienda",
    projects4descri: "Usando datos de multiples viviendas logre crear un modelo predictivo que me permitio obtener un valor aproximado de una vivienda segun diversos factores",
    projects5Title: "Perros vs gatos clasificacion de imagenes",
    projects5descri: "Usando redes neuronalesconvolucionales hice un analisis y posterior clasificacion automatizada de perros y gatos.",
